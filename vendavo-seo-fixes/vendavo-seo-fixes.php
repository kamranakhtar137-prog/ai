...
define( 'VENDAVO_SEO_VERSION', '1.1.0' );
define( 'VENDAVO_SEO_PATH', plugin_dir_path( __FILE__ ) );
define( 'VENDAVO_SEO_URL', plugin_dir_url( __FILE__ ) );

require_once VENDAVO_SEO_PATH . 'includes/class-schema-parser.php';
require_once VENDAVO_SEO_PATH . 'includes/class-output-buffer.php';
require_once VENDAVO_SEO_PATH . 'includes/class-organization-schema.php';
